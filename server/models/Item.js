...
const itemSchema = new Schema({
    destination: { type: String, required: true, minlength: [3, 'Destination name must be atleast 3 characters long']},
    ...
    duration: { type: String, required: true, minlength: [5, 'Duration name must be atleast 5 characters long']},
